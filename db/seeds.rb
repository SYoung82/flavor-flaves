...
recipe_ingredient2 = RecipeIngredient.create(recipe_id: 1, ingredient_id: 2)
recipe_ingredient3 = RecipeIngredient.create(recipe_id: 1, ingredient_id: 3)
recipe_ingredient4 = RecipeIngredient.create(recipe_id: 1, ingredient_id: 4)
recipe_ingredient5 = RecipeIngredient.create(recipe_id: 1, ingredient_id: 5)
recipe_ingredient6 = RecipeIngredient.create(recipe_id: 1, ingredient_id: 6)
recipe_ingredient7 = RecipeIngredient.create(recipe_id: 2, ingredient_id: 7)
recipe_ingredient8 = RecipeIngredient.create(recipe_id: 2, ingredient_id: 8)
recipe_ingredient9 = RecipeIngredient.create(recipe_id: 2, ingredient_id: 9)
recipe_ingredient10 = RecipeIngredient.create(recipe_id: 2, ingredient_id: 10)
recipe_ingredient11 = RecipeIngredient.create(recipe_id: 2, ingredient_id: 11)
